...
public class Business extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5864027439477121259L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Business\",\"namespace\":\"no.sysco.middleware.poc.kafkaschemaregistry.avro\",\"doc\":\"Business record contains name of company and list of customers\",\"fields\":[{\"name\":\"company_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Name of company\"},{\"name\":\"company_telephone\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Company telephone\",\"default\":\"123123\"},{\"name\":\"customers\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Customer\",\"fields\":[{\"name\":\"first_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Customer name\"},{\"name\":\"last_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Customer last name\"},{\"name\":\"middle_name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"Customer middle name\",\"default\":null}]}},\"doc\":\"List of customers\"}],\"version\":\"2\"}");
   ...
   * @param company_telephone Company telephone
